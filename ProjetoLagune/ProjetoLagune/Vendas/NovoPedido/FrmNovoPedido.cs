...
namespace ProjetoLagune.Vendas
{
    public partial class FrmNovoPedido : Form
    {
        ...
        {
            //CODIGO AQUI, ACIMA
            if ((!string.IsNullOrEmpty(cbRazao.Text)) && (!string.IsNullOrEmpty(cbTabela.Text)))
            {
            ...
            {
                MessageBox.Show("Por favor, preencha todos os dados.", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
