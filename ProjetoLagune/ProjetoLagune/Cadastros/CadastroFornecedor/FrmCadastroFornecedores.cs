    ...
    public partial class FrmCadastroFornecedores : Form
    {
        ...
        private async void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            if ((!string.IsNullOrEmpty(txtNome.Text)) && (!string.IsNullOrEmpty(txtLogradouroForn.Text)) && (!string.IsNullOrEmpty(txtBairroForn.Text)) &&
                ...
                (!string.IsNullOrEmpty(txtEstadoForn.Text)) && (!string.IsNullOrEmpty(comboUFForn.Text)) &&
                (mtxtCNPJForn.MaskCompleted))
                {
                    lblNomeFornecedor.Text = "Nome:";
                    lblNomeFornecedor.ForeColor = Color.Black;
                    ...
                    lblCNPJForn.Text = "CNPJ:";
                    lblCNPJForn.ForeColor = Color.Black;
            ...
            else
            {
                ...
                {
                    lblNomeFornecedor.Text = "Nome*:";
                    lblNomeFornecedor.ForeColor = Color.FromArgb(255, 121, 121);
                }
                else
                {
                    lblNomeFornecedor.Text = "Nome:";
                ...
                //========================================================================================
                if (string.IsNullOrEmpty(comboUFForn.Text))
                {
                    lblUFForn.Text = "UF*:";
                ...
                //========================================================================================
                if (!mtxtCNPJForn.MaskCompleted)
                {
                    lblCNPJForn.Text = "CNPJ*:";
                    lblCNPJForn.ForeColor = Color.FromArgb(255, 121, 121);
                }
                else
                {
                    lblCNPJForn.Text = "CNPJ:";
